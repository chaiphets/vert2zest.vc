			...
			<div class="col-md-12">
				<form class="form-horizontal" role="form" method="post" action="<?=site_url('wiki/busstop/save') ?>">
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<div class="btn-group" data-toggle="buttons">
								<label class="btn btn-primary bit-checkbox <?=($busStop['bts']==1)?"active":""?>">
									BTS
									<input type="hidden" name="bts" value="<?=$busStop['bts'] ?>" />
								</label>
								<label class="btn btn-primary bit-checkbox <?=($busStop['mrt']==1)?"active":""?>">
									MRT
									<input type="hidden" name="mrt" value="<?=$busStop['mrt'] ?>" />
								</label>
								<label class="btn btn-primary bit-checkbox <?=($busStop['ship']==1)?"active":""?>">
									SHIP
									<input type="hidden" name="ship" value="<?=$busStop['ship'] ?>" />
								</label>
								<label class="btn btn-primary bit-checkbox <?=($busStop['airlink']==1)?"active":""?>">
									Airport Link
									<input type="hidden" name="airlink" value="<?=$busStop['airlink'] ?>" />
								</label>
								<label class="btn btn-primary bit-checkbox <?=($busStop['brt']==1)?"active":""?>">
									BRT
									<input type="hidden" name="brt" value="<?=$busStop['brt'] ?>" />
								</label>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<div class="btn-group" data-toggle="buttons">
								<label class="btn btn-primary bit-checkbox <?=($busStop['one_side']==1)?"active":""?>">
									One Side
									<input type="hidden" name="one_side" value="<?=$busStop['one_side'] ?>" />
								</label>
