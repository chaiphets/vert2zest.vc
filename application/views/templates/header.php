...
<div id="wrapper">
	...
	<div id="sidebar-wrapper">
	    <ul class="sidebar-nav">
	        ...
	        <li class="active"><a href="<?=site_url('wiki/busstop') ?>"><img width="32px" src="<?= base_url('images/busstop_icon.png')?>" /> Bus Stop Information</a>
	        	<ul>
	        		<li>
	        ...
	        <li>
						<a href="<?=site_url('wiki/bus') ?>"><img width="32px" src="<?= base_url('images/bus_icon.png')?>" /> Bus Information</a>
	        </li>
	    </ul>
	</div>
